...
All notable changes to VibeTube will be documented in this file.
...
- **Remote Server Mode** - Connect to a remote VibeTube server on your network
...
[0.1.0]: https://github.com/jamiepine/VibeTube/releases/tag/v0.1.0
