---
title: "Quick Start"
description: "Get started with Vibetube in 5 minutes"
---
...
Make sure you have [installed Vibetube](/overview/installation) and launched the app.

## Step 1: Create a Voice Profile

Voice profiles are the foundation of Vibetube. Each profile contains voice samples that the AI uses to clone the voice.
...
<Steps>
  ...
  <Step title="Enter Text">
    ...
    ```
    Hello! This is my first voice generation with Vibetube.
    ```
  </Step>
...
<CardGroup cols={2}>
  ...
  <Card title="API Integration" icon="code" href="/api/overview">
    Integrate Vibetube into your own applications
  </Card>
