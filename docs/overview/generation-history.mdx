...
Vibetube keeps a complete history of all generated audio, making it easy to find, reuse, and manage your creations.
...
- **macOS**: `~/Library/Application Support/com.vibetube.app/data/`
- **Windows**: `%APPDATA%/com.vibetube.app/data/`
- **Linux**: `~/.config/com.vibetube.app/data/`
