...
description: "Common issues and solutions for VibeTube"
---

This guide covers common issues you might encounter when using or developing VibeTube, along with solutions.
...
xattr -cr /Applications/VibeTube.app
```
...
<AccordionGroup>
  ...
  <Accordion title="Permission Issues">
    ...
    ```bash
    # macOS/Linux
    chmod +x ~/Library/Application\ Support/com.VibeTube.app/backend/VibeTube-server
    ```
  </Accordion>
  ...
  <Accordion title="Check Logs">
    ...
    **macOS:**
    ```bash
    tail -f ~/Library/Application\ Support/com.VibeTube.app/logs/server.log
    ```

    **Windows:**
    ```bash
    type %APPDATA%\com.VibeTube.app\logs\server.log
    ```
  </Accordion>
</AccordionGroup>
...
**Solutions:**
- Close all VibeTube instances
- Delete the lock file:
  ```bash
  # macOS
  rm ~/Library/Application\ Support/com.VibeTube.app/data/VibeTube.db-shm
  rm ~/Library/Application\ Support/com.VibeTube.app/data/VibeTube.db-wal
  ```
...
```bash
# macOS
rm ~/Library/Application\ Support/com.VibeTube.app/data/VibeTube.db

# Windows
del %APPDATA%\com.VibeTube.app\data\VibeTube.db
```
...
<AccordionGroup>
  ...
  <Accordion title="Check GPU Selection">
    If you have multiple GPUs, ensure VibeTube is using the right one.

    Settings â†’ Generation â†’ GPU Device
  </Accordion>
...
1. **Check GitHub Issues:** [github.com/jamiepine/VibeTube/issues](https://github.com/jamiepine/VibeTube/issues)
2. **Open a New Issue:** Provide:
   - Operating system and version
   - VibeTube version
   - Steps to reproduce
   - Error messages or logs
3. **Join Discord:** [discord.gg/VibeTube](https://discord.gg/VibeTube) (coming soon)
...
For more detailed troubleshooting, see the [TROUBLESHOOTING.md](https://github.com/jamiepine/VibeTube/blob/main/docs/TROUBLESHOOTING.md) file in the repository.
