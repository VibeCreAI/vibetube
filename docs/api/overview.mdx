---
title: "API Overview"
description: "Integrate voice synthesis into your applications with the VibeTube REST API"
---

## Introduction

VibeTube exposes a full REST API that allows you to integrate voice synthesis into your own applications. The API runs on `http://localhost:17493` by default.

<Card title="Interactive API Docs" icon="book" href="http://localhost:17493/docs">
  When VibeTube is running, visit the auto-generated API documentation at `http://localhost:17493/docs`
</Card>
...
The VibeTube API is organized into several categories:
...
VibeTube provides an auto-generated TypeScript client with full type safety:

```typescript
import { VibeTubeClient } from '@/lib/api'

const client = new VibeTubeClient({
