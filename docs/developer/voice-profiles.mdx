...
description: "How voice profile management works in VibeTube"
---

## Overview

Voice profiles are the foundation of VibeTube's voice cloning capability. Each profile stores reference audio samples and metadata that the TTS model uses to clone a voice.
...
â””â”€â”€ profiles/
    â””â”€â”€ {profile_id}/
        â”œâ”€â”€ {sample_id_1}.wav
        â”œâ”€â”€ {sample_id_2}.wav
        â””â”€â”€ ...
```
...
```
profile_export.zip
â”œâ”€â”€ profile.json     # Metadata
â”œâ”€â”€ samples/
â”‚   â”œâ”€â”€ sample_1.wav
â”‚   â””â”€â”€ sample_1.json  # Reference text
â””â”€â”€ ...
```
