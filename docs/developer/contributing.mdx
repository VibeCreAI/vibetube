---
title: "Contributing"
description: "How to contribute to VibeTube"
---

Thank you for your interest in contributing to VibeTube! This guide will help you get started.
...
1. **Read the documentation** to understand how VibeTube works
...
â”‚   â”œâ”€â”€ tts.py        # Voice synthesis logic
...
- Check [existing issues](https://github.com/jamiepine/VibeTube/issues) for bugs
- Test your fix thoroughly
- Add regression tests if possible

### New Features

- Check the [roadmap](https://github.com/jamiepine/VibeTube#roadmap) for planned features
...
- [CHANGELOG.md](https://github.com/jamiepine/VibeTube/blob/main/CHANGELOG.md)
...
2. Search [existing issues](https://github.com/jamiepine/VibeTube/issues)
3. Open a new issue or discussion
4. See [CONTRIBUTING.md](https://github.com/jamiepine/VibeTube/blob/main/CONTRIBUTING.md) in the repo
