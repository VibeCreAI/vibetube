...
description: "How audio output routing works in VibeTube"
---
...
1. Create "Stream" channel â†’ OBS virtual audio
2. Create "Monitor" channel â†’ Headphones
3. Assign "Narrator" profile â†’ Both channels
4. Assign "Character 1" profile â†’ Stream only
