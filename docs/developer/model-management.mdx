...
description: "How model downloading, loading, and status tracking works in VibeTube"
---

## Overview

VibeTube manages two types of models:
...
â”œâ”€â”€ models--Qwen--Qwen3-TTS-12Hz-1.7B-Base/
â”œâ”€â”€ models--Qwen--Qwen3-TTS-12Hz-0.6B-Base/
