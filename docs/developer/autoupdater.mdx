...
VibeTube uses Tauri's built-in auto-updater to deliver updates to users automatically.

## Quick Reference

For detailed setup instructions, see the existing documentation:

- [AUTOUPDATER_QUICKSTART.md](https://github.com/jamiepine/VibeTube/blob/main/docs/AUTOUPDATER_QUICKSTART.md)
- [AUTOUPDATER.md](https://github.com/jamiepine/VibeTube/blob/main/docs/AUTOUPDATER.md)

## How It Works

The auto-updater follows a secure update process:

1. **Check for Updates** - The VibeTube app periodically checks GitHub Releases for new versions
...
```json
{
  "updater": {
    "active": true,
    "endpoints": [
      "https://github.com/jamiepine/VibeTube/releases/latest/download/latest.json"
    ],
    "dialog": true,
...
# Keys saved to ~/.tauri/VibeTube.key
```
...
<Card title="View Full Docs" href="https://github.com/jamiepine/VibeTube/tree/main/docs">
